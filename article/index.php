...
<head>
    ...
    <!-- Link Tailwind Css  -->
    <link rel="stylesheet" href="../tailwindcss.css?v=<?php echo time(); ?>">
    <!-- Link Fornt Google -->
    ...
    <div class="_Nuxt">
        <div class="_Layout">
            <div class=" relative">
                <!--  -->
                <div>
                    <nav class="w-full flex items-center justify-between px-8 py-2 fixed z-50 " style="top: 0;">
                            ...
                            <div class="mt-8 pb-4">
                                <div>
                                    <div class="mt-8 pb-4">
                                        ...
                                        <div class=" grid grid-cols-5 gap-x-10 mt-6">
                                            <a href="">
                                                <div class=" bg-white filter rounded-xl mx-2 mb-6 transform transition duration-300 hover:scale-95 hover:shadow-lg drop-shadow-xl">
                                                    ...
                                                    <div class=" h-60 px-4 pt-4 pb-6 flex flex-col justify-between rounded-b-xl relative">
                                                        ...
                                                        <div class="flex justify-between items-center">
                                                            <div>
                                                                <div class=" text-sm font-thin">បន្ដអានអត្ថបទ</div>
                                                            </div>
                                            ...
                                            <a href="">
                                                <div class=" bg-white filter rounded-xl mx-2 mb-6 transform transition duration-300 hover:scale-95 hover:shadow-lg">
                                                    <img src="assets/image/mak.jfif" alt="" class="h-44 w-full object-cover bg-no-repeat bg-center rounded-t-xl">
                                                    <div class=" h-60 px-4 pt-4 pb-6 flex flex-col justify-between rounded-b-xl relative">
                                                        <div>
                                                            <div class="p-1 bg-white card-profile-container">
